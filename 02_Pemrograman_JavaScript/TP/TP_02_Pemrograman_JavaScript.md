...
Disini saya memperbaiki code pada bagian if (arr[i] >= 0). Kondisi tersebut menyebabkan angka 0 ikut dikalikan sehingga output menjadi 0, karena dalam operasi perkalian jika terdapat 0 maka seluruh hasil menjadi 0.
